...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        gst.AjouterUnEleve(eleve1);gst.AjouterUnEleve(eleve2);
        gst.AjouterUnEleve(eleve3);gst.AjouterUnEleve(eleve4);
        gst.AjouterUnEleve(eleve5);
        
        // Ajouter les tests au gestionnaire
        gst.AjouterUnTest(test1); gst.AjouterUnTest(test2);
        gst.AjouterUnTest(test3); gst.AjouterUnTest(test4);
    ...
    private void btnInscriptionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInscriptionActionPerformed
        ...
        if(lstEleves.getSelectedIndex()== -1)
       {
        ...
        if(gst.getLesElevesInscrits().isEmpty())
        {
            ...
            v3.add(t.getNomTest());
            v3.add(t.getNbFautes());
            v3.add(t.getTermine());
            dtmTests.addRow(v3);
            
           int i = 0;
           for(Eleve e1 : gst.getLesElevesInscrits())
           {
    ...
    private boolean ExisterEleve(boolean a) {
